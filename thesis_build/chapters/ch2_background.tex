...
\section{The Memory Hierarchy and the Five Address Spaces}\label{sec:bg-mem}
...
\section{Visual SLAM and cuVSLAM}\label{sec:bg-slam}
...
\section{The Measurement Instruments}\label{sec:bg-tools}
